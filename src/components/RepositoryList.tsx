  ...
  return (
    <div className="space-y-3">
      {repositories.length === 0 && (
        <p className="rounded-lg border border-slate-200/70 bg-gradient-to-br from-white via-slate-50 to-white p-6 text-sm text-slate-600 shadow-[0_18px_45px_-35px_rgba(15,23,42,0.45)]">
        ...
        return (
          <button
            ...
            className={clsx(
              ...
              'border-slate-200/70 bg-gradient-to-br from-white via-slate-50 to-white shadow-[0_20px_48px_-36px_rgba(15,23,42,0.45)] hover:-translate-y-0.5 hover:shadow-[0_26px_56px_-34px_rgba(15,23,42,0.52)]',
              activeRepositoryId === repo.id &&
                'border-accent/50 bg-gradient-to-br from-accent/10 via-accent/5 to-white text-slate-900 shadow-[0_26px_56px_-32px_rgba(15,23,42,0.55)] ring-2 ring-accent/25',
            )}
